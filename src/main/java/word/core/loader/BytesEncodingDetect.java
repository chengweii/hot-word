...
public class BytesEncodingDetect extends Encoding {
    ...
    public static String detectUrlEncoding(String url){
        int result = OTHER;
        try {
            BytesEncodingDetect sinodetector;
            int i;
            sinodetector = new BytesEncodingDetect();
            result = sinodetector.detectEncoding(new URL(url));
        } catch (Exception e) {
    ...
    public static void main(String argc[]) {
        ...
        int i;
        sinodetector = new BytesEncodingDetect();
        String url = "https://www.jb51.net/article/124551.htm";
        if (url.startsWith("http") == true) {
            ...
            result = sinodetector.detectEncoding(new File(url));
        }
